...
<%
    ...
    if (maxAmountFilter != null) {
        filters = maxAmountFilter.getFilterConditions();
    }
%>
<head>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-0 gap-2">
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5" data-select2-id="select2-data-123-mzxj">
                        <!--begin::Add product-->
                        <a href="${pageContext.request.contextPath}/max-amount/create" class="btn btn-success">
                            Nouveau montant max
                        </a>
                        <!--end::Add product-->
                    </div>
                ...
                <div class="card-body pt-0">
                    <div class="accordion-body">
                        <form method="get">
                            <div class="mb-5">
                                <input id="minAmount" type="text" name="mineq_amount" class="form-control" placeholder="Montant minimum..."
                                    <% if (maxAmountFilter != null && maxAmountFilter.getMineq_amount() != null) { %>
                                       value="<%=maxAmountFilter.getMineq_amount()%>"
                                    <% } %>
                                >
                            </div>
                            <div class="mb-5">
                                <input id="maxAmount" type="number" name="maxeq_amount" class="form-control" placeholder="Montant maximum..."
                                    <% if (maxAmountFilter != null && maxAmountFilter.getMaxeq_amount() != null) { %>
                                       value="<%=maxAmountFilter.getMaxeq_amount()%>"
                                    <% } %>
                                >
                            </div>
                    ...
                    <table class="table table-row-bordered gy-5" id="scenes-list">
                        ...
                        <tbody>
                        <% for(MaxAmount maxAmount : amounts) { %>
                        <tr>
                            <td><%=maxAmount.getId()%></td>
                            <td>
                                <%= maxAmount.getAmount() %> Ar
                            </td>
                            <td>
                                <%= maxAmount.getDate() %>
                            </td>
<%--                            <td>--%>
<%--                                <a href="${pageContext.request.contextPath}/max-amount/update/<%= maxAmount.getId() %>" >--%>
...
<%--                            </td>--%>
                    ...
                    <ul class="pagination">
                        <li
                                ...
                                <% } %>
                        ><a href="${pageContext.request.contextPath}/max-amount?<%=filters%>&page=<%=pageNumber-1%>" class="page-link"><i class="previous"></i></a></li>
                        ...
                        <li
                                ...
                                class="page-item"
                                <% } %>
                        ><a href="${pageContext.request.contextPath}/max-amount?<%=filters%>&page=<%=i%>" class="page-link"><%=i%></a></li>
                        <% } %>
                        <li
                                ...
                                <% } %>
                        ><a href="${pageContext.request.contextPath}/max-amount?<%=filters%>&page=<%=pageNumber+1%>"  class="page-link"><i class="next"></i></a></li>
                    </ul>
