...
<%
    List<VTotalRembourses> reimbursements = (List<VTotalRembourses>) request.getAttribute("reimbursements");
...
%>
<head>
    <title>Total Remboursés par mois</title>
</head>
<!--begin::main-->
...
<%--                            Nouveau Total Remboursés par mois--%>
<%--                        </a>--%>
                        <!--end::Add product-->
                    </div>
                </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table table-row-bordered gy-5" id="scenes-list">
                        ...
                        <tbody>
                        <% for(VTotalRembourses rembourses : reimbursements) { %>
                        <tr>
                            <td>
                                <%= rembourses.getMois() %>
                            </td>
                            ...
                            <td>
                                <%= rembourses.getTotalrembourses() %> Ar
                            </td>
                            <%--                            <td>--%>
                    ...
                    <ul class="pagination">
                        <li
                                ...
                                <% } %>
                        ><a href="${pageContext.request.contextPath}/stats/totalRembourses?<%=filters%>&page=<%=pageNumber-1%>" class="page-link"><i class="previous"></i></a></li>
                        ...
                        <li
                                ...
                                class="page-item"
                                <% } %>
                        ><a href="${pageContext.request.contextPath}/stats/totalRembourses?<%=filters%>&page=<%=i%>" class="page-link"><%=i%></a></li>
                        <% } %>
                        <li
                                ...
                                <% } %>
                        ><a href="${pageContext.request.contextPath}/stats/totalRembourses?<%=filters%>&page=<%=pageNumber+1%>"  class="page-link"><i class="next"></i></a></li>
                    </ul>
